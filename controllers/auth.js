...
exports.postReset = (req, res, next) => {
  crypto.randomBytes(32, (err, buffer) => {
    ...
    User
      ...
      .then(result => {
        res.redirect('/');
        transporter.sendMail({to: req.body.email, from: 'vzdrizhni@gmail.com', subject: 'Requested Password reset', html: `<p>Click this <a href="http://localhost:3000/reset/${token}">Link</a></p>`})
      })
      .catch(err => {
        console.log(err);
      })
